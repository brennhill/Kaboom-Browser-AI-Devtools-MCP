...
const { parseExpression } = await import('../../../extension/background/exec/csp-safe/parser.js')
const { cspSafeExecutor } = await import('../../../extension/background/exec/csp-safe/executor.js')
