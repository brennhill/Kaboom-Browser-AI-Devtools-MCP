...
describe('buildReactValueReconcileExpression (#599 type)', () => {
  ...
  beforeEach(async () => {
    ;({ buildReactValueReconcileExpression } = await import('../../extension/background/cdp-dispatch.js'))
  })
...
describe('shouldEscalateToCDP (#599 dispatch escape hatch)', () => {
  ...
  beforeEach(async () => {
    ;({ shouldEscalateToCDP } = await import('../../extension/background/cdp-dispatch.js'))
  })
