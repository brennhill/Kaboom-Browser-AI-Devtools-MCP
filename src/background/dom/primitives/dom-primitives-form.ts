...
return sections}function buildActionHandlers(node){return{type:()=>withMutationTracking(()=>typeIntoNode(node)),select:()=>withMutationTracking(()=>{const overlayErr=blockedByOverlayError(
