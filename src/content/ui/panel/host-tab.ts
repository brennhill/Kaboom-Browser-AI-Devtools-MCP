...
export function getHostTabIdFromLocation(): number | undefined {
  try {
...
export async function getHostTabId(): Promise<number | undefined> {
 ...
 */
export async function startPageAnnotation(): Promise<void> {
 ...
 */
export async function closeBrowserSidePanel(): Promise<void> {
