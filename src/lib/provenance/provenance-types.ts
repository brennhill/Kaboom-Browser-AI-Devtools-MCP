...
// provenance-types.ts — Content-provenance contract shared by the content script and the background.
...
export const PROVENANCE_CLASSIFICATIONS: readonly ProvenanceClassification[] = [
  'first_party_document',
  'same_origin_subresource',
  'third_party_frame',
  'post_load_injected'
