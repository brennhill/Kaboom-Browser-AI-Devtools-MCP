#!/usr/bin/env python3
# Purpose: Automate generate-feature-navigation.py workflow behavior for repository tooling.
...
canonical: true
auto-generated: true
generation-script: scripts/docs/generate-feature-navigation.py
...
**Generated:** {CURRENT_DATE} | **Auto-generated by:** `scripts/docs/generate-feature-navigation.py`
...
9. **Run this script:** `python3 scripts/docs/generate-feature-navigation.py`
...
```bash
python3 scripts/docs/generate-feature-navigation.py
```
...
**Note:** This file is auto-generated. Do not edit it manually. Run `python3 scripts/docs/generate-feature-navigation.py` to update.
"""
