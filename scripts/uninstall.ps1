...
#
# PURPOSE:
# Reverses every artifact created by scripts/install.ps1 and by
...
#
# USAGE:
#   irm https://raw.githubusercontent.com/brennhill/Kaboom-Browser-AI-Devtools-MCP/STABLE/scripts/uninstall.ps1 -OutFile uninstall.ps1; ./uninstall.ps1 -Yes
#   ./scripts/uninstall.ps1            # interactive (prompts before removing)
#   ./scripts/uninstall.ps1 -DryRun    # show what would be removed
#   ./scripts/uninstall.ps1 -KeepData  # keep logs/recordings/project state
...
Write-Host "  irm https://raw.githubusercontent.com/brennhill/Kaboom-Browser-AI-Devtools-MCP/STABLE/scripts/install.ps1 | iex"
