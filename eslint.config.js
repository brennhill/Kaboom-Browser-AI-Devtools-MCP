...
export default [
  // Ignore patterns
  {
    ignores: [
      ...
      // Vendored terminal assets (xterm.js). The terminal was moved under
      // internal/terminal (commit eb248ff6); keep both paths so the vendored
      // minified bundle stays ignored wherever it lives.
