...
export class PerformanceTraceController {
    ...
    async start(tabId, options = {}) {
        ...
        const opened = requireStartResponse(await this.deps.postJSON('/performance-trace/start', { tab_id: tabId, replace_active: true }));
        const active = {
 ...
 */
export function isTargetNotDebuggableError(error) {
