...
import { gesturePrimitiveFor, gestureModifierMask, buildGestureDOMResult, needsGestureDispatch } from './primitives/gestures/dom-primitives-gestures.js';
import { resolveElement } from './cdp/cdp-element-resolve.js';
...
async function executeGestureAction(target, params) {
...
async function routeDOMExecution(action, target, params) {
    ...
    if (needsGestureDispatch(action, params.modifiers))
        return executeGestureAction(target, params);
