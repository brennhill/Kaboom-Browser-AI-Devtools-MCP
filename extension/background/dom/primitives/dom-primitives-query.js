...
export function domPrimitiveQuery(selector, options) {
    ...
    function resolveElements(sel, root = document) {
        if (!sel || !sel.trim())
            return [];
...
//# sourceMappingURL=dom-primitives-query.js.map