...
export function showAPIBillingWarning() {
    showActionToast('API billing is active', 'Using API billing, not your subscription. Log out and sign in with your subscription account.', 'warning', 12000);
}
/** Render a start failure inline when mounted, otherwise fail loud via toast. */
export function surfaceTerminalStartFailure(container, message, instruction, command) {
    if (container) {
