...
function compileUserScript(cleanScript) {
    const forms = [
        ...
        () => new Function(`"use strict"; return (${cleanScript});`), // nosemgrep: javascript.lang.security.eval.rule-eval-with-expression -- Function() constructor for controlled sandbox execution
        // eslint-disable-next-line no-new-func
        () => new Function(`"use strict"; ${cleanScript}`), // nosemgrep: javascript.lang.security.eval.rule-eval-with-expression -- Function() constructor for controlled sandbox execution
