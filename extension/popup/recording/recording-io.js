...
function sendRecordStart(els, state, audioMode, showRecording, showIdle, showStartError) {
...
// #lizard forgives
function tryMicPermissionThenStart(els, state, audioMode, showRecording, showIdle, showStartError) {
