...
function notifyTrackingState(tabId, isTracked) {
    chrome.tabs
        ...
        .catch(() => {
        // tab closed or content script absent; storage remains the source of truth
    });
}
/**
 ...
 */
export async function untrackTab(prevTabId, onStopped) {
...
//# sourceMappingURL=tab-tracking-core.js.map