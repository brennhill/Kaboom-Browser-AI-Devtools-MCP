...
**Code:**
- `internal/queries/dispatcher_commands.go` (`RegisterCommand`, `ApplyCommandResult`, `ExpireCommand`)
...
- `internal/analysis/apicontract/contract.go` - API contract baselines and drift detection
