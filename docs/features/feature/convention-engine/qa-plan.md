...
Source under test: `internal/hook/conventions/conventions.go`, `internal/hook/conventions/conventions.go`. Tests: `convention_discover_test.go`, `convention_detect_test.go`.
