...
| IT-4 | Install contract | `scripts/install-upgrade-regression.contract.test.mjs`, `scripts/test-install-hooks-only.sh` | Install/upgrade preserves user settings and updates managed entries | must |
