...
`scripts/build/generate-wire-types.js` generates the TS side. `scripts/check-wire-drift.js`
...
4. Delete `scripts/build/generate-wire-types.js` and `scripts/check-wire-drift.js`.
