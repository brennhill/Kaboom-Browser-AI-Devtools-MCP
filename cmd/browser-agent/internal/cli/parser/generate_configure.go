...
func configureResourceFlagSpecs() map[string]cliFlagSpec {
	return map[string]cliFlagSpec{
		...
		"--doctor-action":      {MCPKey: "doctor_action", Kind: FlagString},
		"--confirmation-token": {MCPKey: "confirmation_token", Kind: FlagString},
		"--output-path":        {MCPKey: "output_path", Kind: FlagString},
		// Report issue
