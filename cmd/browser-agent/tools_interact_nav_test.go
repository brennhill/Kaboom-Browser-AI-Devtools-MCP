...
func TestHandleBrowserActionNewTab_InvalidJSON(t *testing.T) {
	...
	resp := env.handler.browserActions.Handle("new_tab", req, args)
...
func TestSwitchTab_UpdatesTrackedTabOnSuccess(t *testing.T) {
	...
	capturefixture.Track(env.capture, 100, "https://old-page.example.com")
	...
	req := mcp.JSONRPCRequest{JSONRPC: "2.0", ID: 1}
	resp := env.handler.browserActions.Handle("switch_tab", req, json.RawMessage(`{"tab_id":200}`))
...
func TestSwitchTab_SetTrackedFalse_NoUpdate(t *testing.T) {
	...
	req := mcp.JSONRPCRequest{JSONRPC: "2.0", ID: 1}
	_ = env.handler.browserActions.Handle("switch_tab", req, json.RawMessage(`{"tab_id":300,"set_tracked":false}`))
...
func TestSwitchTab_FailedCommand_NoUpdate(t *testing.T) {
	...
	req := mcp.JSONRPCRequest{JSONRPC: "2.0", ID: 1}
	_ = env.handler.browserActions.Handle("switch_tab", req, json.RawMessage(`{"tab_id":999}`))
...
func TestSwitchTab_TabIDZero_NoUpdate(t *testing.T) {
	...
	req := mcp.JSONRPCRequest{JSONRPC: "2.0", ID: 1}
	_ = env.handler.browserActions.Handle("switch_tab", req, json.RawMessage(`{"tab_id":42}`))
...
func TestSwitchTab_AsyncMode_NoImmediateTrackingUpdate(t *testing.T) {
	...
	resp := env.handler.browserActions.Handle("switch_tab", req, args)
