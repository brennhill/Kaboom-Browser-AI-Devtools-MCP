...
var actionSpecs = []ActionSpec{
	...
	{Name: "right_click", Hint: "Right-click to open a context menu (raises a real contextmenu event, which element.click() cannot)", Returns: "Confirmation of the click, and whether the contextmenu event reached the page.", Optional: []string{"selector", "element_id", "index", "nth", "scope_selector", "frame", "x", "y", "modifiers", "reason", "correlation_id", "timeout_ms"}},
	{Name: "double_click", Hint: "Double-click an element or coordinate (one burst with clickCount=2, so the page receives dblclick)", Returns: "Confirmation the double click was dispatched, with the click count the page saw.", Optional: []string{"selector", "element_id", "index", "nth", "scope_selector", "frame", "x", "y", "modifiers", "reason", "correlation_id", "timeout_ms"}},
	{Name: "triple_click", Hint: "Triple-click to select a whole line or paragraph before replacing it", Returns: "Confirmation the triple click was dispatched, with the click count the page saw.", Optional: []string{"selector", "element_id", "index", "nth", "scope_selector", "frame", "x", "y", "modifiers", "reason", "correlation_id", "timeout_ms"}},
