...
var actionSpecs = []ActionSpec{
	...
	{Name: "click", Hint: "Click an element by selector, element_id, or coordinates", Returns: "Confirmation the element was clicked, and the URL if it navigated.", Optional: []string{"selector", "element_id", "ref", "index", "nth", "scope_selector", "frame", "reason", "correlation_id", "timeout_ms", "x", "y", "analyze", "wait_for_stable", "stability_ms"}},
