...
func TestCaptureHasNoCompatibilityAliases(t *testing.T) {
	...
	for _, forbidden := range []string{
		...
		"func (s *TelemetryStore) GetNetworkErrorTotalAdded(",
		"func (s *TelemetryStore) GetAllEnhancedActions(",
		"func (s *TelemetryStore) GetActionTotalAdded(",
		"func (s *TelemetryStore) ClearActionBuffer(",
		"func (s *TelemetryStore) GetAllWebSocketEvents(",
		"func (s *TelemetryStore) GetWebSocketTotalAdded(",
		"func (s *TelemetryStore) GetWebSocketEvents(",
		"func (s *TelemetryStore) GetWebSocketStatus(",
		"func (s *TelemetryStore) ClearWebSocketBuffers(",
		"getSettingsPath(",
		"readSettingsData(",
		"QueryDispatcher =",
		"QuerySnapshot =",
